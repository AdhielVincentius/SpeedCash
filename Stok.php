...
<body>
    <div class="container">
        ...
        <button class="button" onclick="window.location.href='tambah_barang.php'">Tambah Barang</button>
        <button class="button" onclick="window.location.href='update_stok.php'">Update Stok</button>
        <button class="button" onclick="window.location.href='hapus_barang.php'">Hapus Barang</button>
    </div>
