...
<head>
    ...
    <style>
        body {
            ...
            background: url('fridge.jpg') no-repeat center center;
...
<body>
    <div class="container">
        ...
        <button class="button" onclick="window.location.href='Stok.php'">Stok Barang</button>
        <button class="button" onclick="window.location.href='update_harga.php'">Update Harga Barang</button>
    </div>
